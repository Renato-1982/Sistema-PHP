...
<?php
    ...
    if ($_POST['nivelacesso'] == 'Nível Acesso'){//VALIDAR O NIVEL ACESSO
        ...
        echo "<h5><a class='btn btn-outline-primary w-100' href='inicio.php?menuop=usuarioscadastraradmin'><i class='bi bi-arrow-return-left'></i> Voltar</a></h5>";  
        ...
        echo "<h5><a class='btn btn-outline-primary w-100' href='inicio.php?menuop=usuarioscadastraradmin'><i class='bi bi-arrow-return-left'></i> Voltar</a></h5>"; 
    }elseif(!empty($verifica)){//VERIFICA SE O EMAIL JA ESTA CADASTRADO
