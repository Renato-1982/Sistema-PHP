<?php
    ...
    if( isset($_POST["nivelacesso"]) && isset($_POST["senha"]) ){
        $nivelacesso =  mysqli_escape_string($conexao,$_POST["nivelacesso"]);
        $senha = hash('sha256',$_POST["senha"]);
        //SELECT DOS DADOS NO BANCO
        $query = "SELECT * FROM usuarios WHERE nivelacesso = '{$nivelacesso}' and senha = '{$senha}'";
        ...
        if( $linha != 0 ) {
            ...
            header('Location: usuarioscadastrar.php');
        }else{
            //MENSAGEM DE ERRO
    ...
    <div class="container">
        <div class="row vh-100 align-items-center justify-content-center">
            <div class="formulario col-10 col-sm-8 col-md-6 col-lg-4 p-4 bg-white">
                ...
                <!--FORMULARIO-->
                <form class="needs-validation" action="usuariosacessar.php" method="POST" novalidate>
                    <!--NIVEL ACESSO-->
                    ...
                    <!--BOTAO-->
                    <div class="form-group mb-3">
                        <button class="btn btn-outline-primary w-100"><i class="bi bi-box-arrow-in-right"></i> Acessar</button>     
                    </div>
                    <!--BOTAO-->
